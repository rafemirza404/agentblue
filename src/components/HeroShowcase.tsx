...
/* Aceternity-style bordered showcase box that sits directly below the hero.
   Animated word-by-word heading, gradient border accents, and a framed
   dashboard preview — restyled to the AgentBlue brand. */
  ...
  return (
    <div className="relative bg-white">
      ...
      <div className="px-4 py-10 md:py-20">
        <h2 className="relative z-10 mx-auto max-w-4xl text-center text-2xl text-[#0A2540] md:text-4xl lg:text-6xl">
        ...
        <motion.p
          ...
          className="relative z-10 mx-auto max-w-xl py-4 text-center text-lg font-normal text-[#425466]"
        >
        ...
        >
          ...
          <CalendarBooking
            trigger={
              <button className="w-60 transform rounded-lg border border-gray-300 bg-white px-6 py-2 font-medium text-[#0A2540] transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-100">
                Book a call
              </button>
            }
          />
